...
|preserve-security-and-policy-values|Preserve security and policy values|
|preserve-credentials|Preserve credentials|
|preserve-access-control-policies|Preserve access control policies|
|preserve-environment-variable-values|Preserve environment variable values|
|preserve-operational-values|Preserve operational values|
