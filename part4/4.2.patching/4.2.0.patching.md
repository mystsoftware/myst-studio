...
If the Platform Instance has already been provisioned then we will need to apply the patch, for details on how to do this, see [Chapter 3.6 - Managing Platform Instances](../../part3/3.6.managingPlatformInstances/3.6.0.managingPlatformInstances.md) for further details.
