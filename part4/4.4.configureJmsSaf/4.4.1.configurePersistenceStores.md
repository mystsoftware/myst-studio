...
This section describes how to define persistant stores as part of our Platform Blueprint.

### Defining the Global Persistence Strategy
One of the key design decisions when defining our Platform Blueprint is whether to use a file-based or a JDBC-enabled database persistent store. This is specified in step 4 of the Platform Bluerint wizard as shown below.
